    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wellness_intention', models.CharField(blank=True, max_length=255)),
                ('theme', models.CharField(choices=[('light', 'Light'), ('dark', 'Dark'), ('lavender', 'Soft Lavender')], default='dark', max_length=20)),
                ...
                ('mood_baseline', models.IntegerField(blank=True, null=True)),
